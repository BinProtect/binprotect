...
#define PROLOG_SIZE			40 // 32 // 33 // 30
#define EPILOG_SIZE 		57 // 50 // 46
...
private:
	...
	unsigned char prolog[PROLOG_SIZE] = {
		...
		0x81, 0xfd, 0x00, 0x00, 0x00, 0xb0,			// cmp ebp, 0xb0000000
		0x72, 0x05,									// jump to popa
		0x8b, 0x4d, 0x04,							// mov ecx, [ebp+0x04]
//		0x8b, 0x4c/*0x4d*/, 0x24, 0x24,				// mov ecx, [esp+0x24]
	...
	unsigned char epilog[EPILOG_SIZE] = {
		...
		0x81, 0xfd, 0x00, 0x00, 0x00, 0xb0,			// cmp ebp, 0xb0000000
		0x72, 0x13,									// jump to popa
		0x8b, 0x4d, 0x04,							// mov    ecx,DWORD PTR [ebp+0x04]
